...
class Job extends Model
{
    ...
    {
        return ($val !== null) ? ('/images/jobs/'.$val) : '/admin/img/logo.png';
    }

    public function translations(): hasOne
    {
        return $this->hasOne(JobTranslations::class);
    }

    public function defaultTranslation(): HasOne
    {
        return $this->translations()->select('job_id', 'title','description')->where('locale', app()->getLocale());
    }
