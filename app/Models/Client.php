...
class Client extends Model
{
    ...
    {
        return ($val !== null) ? ('/images/clients/'.$val) : '/admin/img/logo.png';
    }

    public function translations(): hasOne
    {
        return $this->hasOne(ClientTranslation::class);
    }

    public function defaultTranslation(): HasOne
    {
        return $this->translations()->select('client_id', 'title')->where('locale', app()->getLocale());
    }
