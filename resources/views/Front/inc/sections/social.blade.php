            ...
            <div class="col-lg-6">
                <div class="social-content">
                    <div class="top-icon d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32.017" height="30.256" viewBox="0 0 32.017 30.256" > <g id="Page-1" transform="translate(0 -0.435)"> <g id="Artboard" transform="translate(0 0.435)"> <g id="icn_fluxo_stacks" transform="translate(0 0)"> <path id="Path" d="M16.009,95.979,0,89.1v3.522L16.009,99.5l16.009-6.884V89.1l-3.2,1.441Z" transform="translate(0 -69.244)" fill="#4d5bed" /> <path id="Path-2" data-name="Path" d="M32.017,9.88V7.319L16.009.435,0,7.319V9.88l16.009,6.884Z" transform="translate(0 -0.435)" fill="rgba(124,135,251,0.65)" /> <path id="Path-3" data-name="Path" d="M28.816,59.076,16.009,64.519,0,57.635v3.522l16.009,6.884,16.009-6.884V57.635Z" transform="translate(0 -44.828)" fill="#4d5bed" /> </g> </g> </g> </svg>
                    </div>
                    <h3 class="anim">{{ $home_setting->translations->social_title }}</h3>
                    <p class="anim">{{ $home_setting->translations->social_description }}</p>
                </div>
            </div>
